...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        return (np.asarray(samples, dtype=np.float64), labels)
    ...
    def fitting(self):
        ...
        for x in range(len(self.decision_trees)):

          self.decision_trees[x].learn(self.bootstraps_datasets[x], self.bootstraps_labels[x])
